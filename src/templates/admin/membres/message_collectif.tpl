{include file="admin/_head.tpl" title="Message collectif" current="membres/message" custom_css=["!web/css.php"]}
...
<form method="post" action="{$self_url_no_qs}">
	...
	<fieldset class="mailing">
		...
		<dl>
			...
			<dd class="help">
				Vous pouvez cibler précisément des membres en créant une <a href="{$admin_url}membres/recherche.php">recherche avancée</a> et en l'enregistant.
