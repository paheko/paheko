    ...
    <div id="orderFields">
        ...
        <fieldset id="f_{$nom}">
            ...
            <dl>
                ...
                <dd class="help">Si coché, ce champ ne sera pas visible par les membres dans leur section "Mes infos personnelles". Attention, il apparaîtra quand même sur l'export de données RGPD que le membre peut télécharger, et qui contiendra toutes les données concernant ce membre.</dd>
