...
<form method="post" action="{$self_url|escape}">
    ...
    <fieldset>
        ...
        <dl>
            ...
            <dd><input type="date" name="debut" id="f_debut" value="{form_field name=debut}" size="10" /></dd>
            <dt><label for="f_fin">Fin de l'exercice</label> <b title="(Champ obligatoire)">obligatoire</b></dt>
            <dd><input type="date" name="fin" id="f_fin" value="{form_field name=fin}" size="10" /></dd>
        </dl>
    </fieldset>
