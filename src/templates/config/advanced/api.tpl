...
<form method="post" action="">
	<fieldset>
		...
		<dl>
			...
			<dd class="help">Attention&nbsp;: tout accès à l'API permet également de télécharger la base de données complète, et donc les mots de passe (chiffrés) des membres.</dd>
		</dl>
		<p class="submit">
			{csrf_field key=$csrf_key}
