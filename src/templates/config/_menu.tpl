...
<nav class="tabs">
	...
	{if $current == 'users'}
		...
		<ul class="sub">
			...
			<li{if $sub_current == 'categories'} class="current"{/if}><a href="{$admin_url}config/categories/">{if MANAGE_PERMISSIONS}Catégories &amp; droits des membres{else}Catégories{/if}</a></li>
		</ul>
