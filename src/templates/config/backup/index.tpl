...
<fieldset>
	...
	<dl>
		...
		<dd><a href="{$admin_url}users/?export=ods">Export de la liste des membres au format tableur LibreOffice Calc / Excel</a></dd>
		<dd><a href="{$admin_url}users/?export=csv">Export de la liste des membres au format CSV</a></dd>
