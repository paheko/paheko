...
<form method="post" action="{$self_url}" data-focus="1">
	...
	{if $edit_disabled}
		<p class="block alert">
			Il n'est pas possible de modifier le libellé, le numéro ou la position de ce compte car il {if $account.user}est utilisé par des écritures liées à des exercices clôturés{else}fait partie du plan comptable officiel{/if}.<br />
