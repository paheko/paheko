...
<dl>
	...
	{input type="checkbox" label="Compte archivé" name="archived" source=$account value=1 help="Si coché, le compte ne pourra plus être sélectionné dans les écritures"}
