...
$graphs = [
	...
	ADMIN_URL . 'acc/reports/pie.php?type=revenue&year=%s' => 'Répartition recettes',
	ADMIN_URL . 'acc/reports/pie.php?type=expense&year=%s' => 'Répartition dépenses',
	ADMIN_URL . 'acc/reports/pie.php?type=assets&year=%s' => 'Répartition actif',
];
