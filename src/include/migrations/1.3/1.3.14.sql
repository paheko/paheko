...
UPDATE acc_charts SET name = 'Plan comptable associatif (2018, révision 2024)' WHERE code = 'fr_pca_2018';
UPDATE acc_charts SET name = 'Plan comptable général, pour entreprises (2014, révision 2024)' WHERE code = 'fr_pcg_2014';
